...
class InterfaceDetector:
    ...
    def __init__(self,root):
        ...
        self.registrar_entrada("ABC1P34", "18:30:12")
        self.registrar_saida("ABC1P34", "22:02:01")
        self.registrar_entrada("DNF2F21", "08:27:58")
        self.registrar_saida("DNF2F21", "17:45:00")
        self.registrar_entrada("FGN5G45", "19:30:00")
        self.registrar_saida("FGN5G45", "23:00:00")
        self.registrar_entrada("EFI7U47", "12:14:00")
        self.registrar_saida("EFI7U47", "15:00:12")
        self.registrar_entrada("FEU4G49", "20:58:12")
        self.registrar_saida("FEU4G49", "22:27:45")
    ...
    def carregar_imagem_fundo(self):  
        imagem_fundo = Image.open("fundocinzalogo.png")
    ...
    def criar_frame_label(self):
       ...
       #Frame Registro
        ...
        self.imageV = PhotoImage(file="novideo250px.png")
        ...
        self.image_controle = Image.open("abst.png")
    ...
    def criar_botoes_controle(self,frame_controle):
        #seleçao de camera
        self.icon_select = PhotoImage(file="icon-select.png")
        ...
        #Iniciar Vídeo    
        self.icon_iniciarVideo = PhotoImage(file="icon-video.png")
        ...
        #Fazer a Detecção
        self.icon_detectar = PhotoImage(file="icon-detectar.png")
        ...
        self.icon_on = PhotoImage (file="icon-ativo.png")
        self.icon_off = PhotoImage(file="icon-desativado.png")
        ...
        #Salvar Registro
        self.icon_salvar = PhotoImage(file="icon-salvar.png")
    ...
    def registrar_entrada(self,placa, horario_entrada):
        ...
        self.treeview.insert('', 'end', values=(placa, horario_entrada, '')) 
    ...
    def registrar_saida(self,placa, horario_saida):
        ...
        for item in self.treeview.get_children():
            if self.treeview.item(item, 'values')[0] == placa and self.treeview.item(item, 'values')[2] == '':
                self.treeview.item(item, values=(placa, self.treeview.item(item, 'values')[1], horario_saida))
                break
